...
$mapinfo = mapasdevista_get_maps();
$mapinfo_key = key($mapinfo);
$mapinfo = $mapinfo[$mapinfo_key];
    ...
    <?php foreach ($mapinfo['filters'] as $filter): ?>
        ...
        <?php elseif ($filter == 'post_types') : ?>
            ...
            <ul class="filter-group" id="filter_post_types">
                <li><h3><!--<?php _e('Content Types', 'mapasdevista'); ?>-->Tipo</h3></li>
